<div>
  ...
  <div id="sidebar" class="sidebar-mobile" role="dialog" aria-modal="true">
    <div class="sidebar-mobile-bg"></div>
    <div class="sidebar-mobile-position">
      <div class="sidebar-mobile-container">
        ...
        <div class="sidebar-mobile-navcontainer">
          <nav class="sidebar-mobile-nav">
            ...
            <a href="dashboard.php" class="sidebar-mobile-nav-link">
            ...
            <a href="#" class="sidebar-mobile-betweennav sidebar-mobile-nav-link">
            ...
            <a href="leden.php" class="sidebar-mobile-betweennav sidebar-mobile-nav-link">
              <!-- Heroicon name: outline/users -->
              <svg class="sidebar-mobile-img" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
              </svg>
      ...
      <div class="sidebar-mobile-dummy">
    ...
    <div class="sidebar-desktop-container">
      ...
      <div class="sidebar-desktop-navcontainer">
        <nav class="sidebar-desktop-nav">
          ...
          <a href="leden.php" class="sidebar-desktop-link">
            <!-- Heroicon name: outline/users -->
            <svg class="sidebar-desktop-img" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
            </svg>
            ...
            <div class="searchform">
              ...
              <div class="search-container">
                <div class="icon-container">
                  ...
                  <svg class="searchbar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd" />
                  </svg>
                </div>
                <input id="search-field" class="searchbar-input" onkeyup="searchfuntion()" placeholder="Search" type="text" name="search">
              </div>
            </div>
          </div>
            ...
            <div class="profile-dropdown profile-show">
              <div>
                <button type="button" class="profile-dropdown-button" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="profile-dropdown-img" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                </button>
              </div>
